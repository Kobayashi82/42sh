...
/*   Updated: 2026/01/06 00:20:10 by vzurera-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#pragma region "Help / Version"
	...
	#pragma region "Help"
		...
		int bt_suspend_help(int format, int no_print) {
			char *name = "suspend";
			char *syntax = "suspend [-f]";
			char *description = "Suspend shell execution.";
			char *msg =
...
#pragma region "Suspend"
	...
	int bt_suspend(int argc, char **argv) {
		...
		t_parse_result *result = parse_options(argc, argv, "", NULL, long_opts, "suspend [-f]", 0);
		if (!result)		return (1);
