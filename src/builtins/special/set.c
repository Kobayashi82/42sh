...
/*   Updated: 2026/01/05 20:33:03 by vzurera-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#pragma region "Help"
	...
	int bt_set(int argc, char **argv) {
		...
		t_parse_result *result = parse_options(argc, argv, "abefhmnopuvxBCEHPTSVXLFN", NULL, long_opts, "set [-abefhmnpuvxBCEHPTSVXLFN] [-o option-name] [--] [-] [arg ...]", 0);
		if (!result)		return (1);
