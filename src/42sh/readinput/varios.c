...
/*   Updated: 2024/12/06 22:48:09 by vzurera-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int options_write() {
	...
	print(fd, ft_strjoin_sep("hist_on=", ft_itoa(options.history_on), "\n", 2), FREE_JOIN);
	print(fd, ft_strjoin_sep("hist_local=", ft_itoa(options.history_local), "\n", 2), FREE_PRINT);
